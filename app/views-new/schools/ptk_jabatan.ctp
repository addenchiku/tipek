	...
	<div class="msgbar msg_Info">
            ...
            <table class="rekap persist-area">
                ...
                <tr valign="middle" style="background-color:#999999; border:1px solid #999999;">
                    ...
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Kepala Sekolah">KSK</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Kepala Perpustakaan">KPS</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Tenaga Pembantu Perpustakaan">TPP</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Kepala Tenaga Adminstrasi">KTA</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Tenaga Administrasi">TA</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Kepala Laboraturium">KLB</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Tenaga Laboraturium">TLB</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Laboran">LAB</td>
                    <td style="background-color:#999999; color:#fff;font-size:12px;" class="tip_south" title="Pengawas Sekolah">PGS</td>
