<div id="top">
    <h1> Tata Informasi Pembangunan </h1>
</div>
...
<div id="botom" class="clearfix">
    <ul id="bawah">
      <li>
        <a id="laporan" class="tumbul" href="">laporan</a>
    </li>
    <li>
        <a id="entry" class="tumbul" href="<?php echo $this->webroot;?>schools/input_data">entry</a>
    </li>
    <li>
        <a id="konfig" class="tumbul" href="<?php echo $this->webroot;?>kecamatans">konfig</a>
    </li>
</ul>
</div>