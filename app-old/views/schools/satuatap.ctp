...
<div class="msgbar msg_Info">
    <b>DAFTAR SEKOLAH BERDASARKAN SATU ATAP</b>
</div>
...
<table class="rekap persist-area">
    ...
    <tr class="textLeft contentIsi">
        <td style="background-color:#c4dc7e; border:1px solid #999999;" colspan="8">DAFTAR SD/MI/SDLB Satu Atap</td>
    </tr>
    <tr class="textLeft contentIsi">
        <td>&nbsp;</td>
    ...
    <tr class="textLeft contentIsi">
        <td style="background-color:#c4dc7e; border:1px solid #999999;" colspan="8">DAFTAR SD/MI/SDLB Bukan Satu Atap</td>
    </tr>
